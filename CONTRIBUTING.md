Contributing to GlobeDex Core
============================

The GlobeDex Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/globedex-project/globedex/blob/master/doc/translation_process.md)
...
The following applies to code changes to the GlobeDex Core project, and is not to be
confused with overall GlobeDex Network Protocol consensus changes.

Whether a pull request is merged into GlobeDex Core rests with the project merge
...
Patches that change GlobeDex consensus rules are considerably more involved than
...
Where a patchset proposes to change the GlobeDex consensus, it must have been
...
The project leader is the release manager for each GlobeDex Core release.
