...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='globedex.conf'
CONFIGFOLDER='/root/.globedex'
COIN_DAEMON='globedexd'
COIN_CLI='globedex-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/globedex/GBDX/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
