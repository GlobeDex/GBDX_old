...
RESOURCES += src/qt/globedex.qrc src/qt/globedex_locale.qrc

TRANSLATIONS += src/qt/locale/globedex_bg.ts \
                src/qt/locale/globedex_de.ts \
                src/qt/locale/globedex_en.ts \
                src/qt/locale/globedex_es.ts \
                src/qt/locale/globedex_fi.ts \
                src/qt/locale/globedex_fr.ts \
                src/qt/locale/globedex_it.ts \
                src/qt/locale/globedex_ja.ts \
                src/qt/locale/globedex_pl.ts \
                src/qt/locale/globedex_pt.ts \
                src/qt/locale/globedex_ru.ts \
                src/qt/locale/globedex_sk.ts \
                src/qt/locale/globedex_sv.ts \
                src/qt/locale/globedex_vi.ts \
                src/qt/locale/globedex_zh_CN.ts \
                src/qt/locale/globedex_zh_TW.ts
