...
The script [extract-osx-sdk.sh](https://github.com/globedex-project/globedex/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
globedex/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/globedex-project/globedex/blob/master/doc/README_osx.md) for troubleshooting tips.