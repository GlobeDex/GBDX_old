...
class ReorgStakeTest(GlobeDexTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected GBDX supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check GBDX supply at the beginning
        # ------------------------------------------
        # GBDX supply: block rewards minus burned fees for minting
        ...
        # Verify that GBDX supplies were properly updated after the spends and reorgs
        self.log.info("Check GBDX supply...")
