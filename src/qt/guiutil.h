...
/** Utility functions used by the GlobeDex Qt UI.
 */
namespace GUIUtil
{
...
// Render GBDX addresses in monospace font
...
// Parse "globedex:" URI into recipient object, return true on successful parsing
