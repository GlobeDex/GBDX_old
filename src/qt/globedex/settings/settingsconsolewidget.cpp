...
#include "qt/globedex/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/globedex/settings/moc_settingsconsolewidget.cpp"
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the GBDX RPC console.") + "<br>" +
