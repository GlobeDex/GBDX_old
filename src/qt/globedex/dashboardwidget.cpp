...
#include "qt/globedex/forms/ui_dashboardwidget.h"
#include "qt/globedex/sendconfirmdialog.h"
#include "qt/globedex/txrow.h"
    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of GBDX earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 GBDX");
...
void DashboardWidget::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("GBDX")
    updateDisplayUnit();
}
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair GBDX
