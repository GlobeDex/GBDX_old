...
#include "qt/globedex/forms/ui_topbar.h"
#include "qt/globedex/loadingdialog.h"
#include "qt/globedex/lockunlock.h"
#include "qt/globedex/qtutils.h"
#include "qt/globedex/receivedialog.h"
                                                        ...
                                                        ui(new Ui::TopBar)
{
    ...
    ui->pushButtonConf->setButtonText("globedex.conf");
...
void TopBar::onBtnConfClicked()
{
    ...
    if (!GUIUtil::openConfigfile())
        inform(tr("Unable to open globedex.conf with default application"));
}
