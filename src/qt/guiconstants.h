...
/* GlobeDex GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GlobeDex"
#define QAPP_ORG_DOMAIN "globedex.org"
#define QAPP_APP_NAME_DEFAULT "GlobeDex-Qt"
#define QAPP_APP_NAME_TESTNET "GlobeDex-Qt-testnet"
