...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GlobeDex globedex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  globedex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded globedex transaction") + "\n" +
                               "  globedex-tx [options] -create [commands]   " + _("Create hex-encoded globedex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded globedex transaction
