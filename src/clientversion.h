...
#error Client version information missing: version is not defined by globedex-config.h or in any other way
#endif
...
/**
 * globedexd-res.rc includes this file, but it cannot cope with real c++ code.
