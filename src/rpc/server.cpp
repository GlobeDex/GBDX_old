...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop GlobeDex server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "GlobeDex server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GBDX features */
        {"globedex", "listmasternodes", &listmasternodes, true },
        {"globedex", "getmasternodecount", &getmasternodecount, true },
        {"globedex", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"globedex", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"globedex", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"globedex", "masternodecurrent", &masternodecurrent, true },
        {"globedex", "startmasternode", &startmasternode, true },
        {"globedex", "createmasternodekey", &createmasternodekey, true },
        {"globedex", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"globedex", "listmasternodeconf", &listmasternodeconf, true },
        {"globedex", "getactivemasternodecount", &getactivemasternodecount, true },
        {"globedex", "getmasternodestatus", &getmasternodestatus, true },
        {"globedex", "getmasternodewinners", &getmasternodewinners, true },
        {"globedex", "getmasternodescores", &getmasternodescores, true },
        {"globedex", "mnsync", &mnsync, true },
        {"globedex", "spork", &spork, true },
...
{
    return "> globedex-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:42225/\n";
}
